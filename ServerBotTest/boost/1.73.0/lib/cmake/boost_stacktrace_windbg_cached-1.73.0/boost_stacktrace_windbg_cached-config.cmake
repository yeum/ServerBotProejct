...
if(EXISTS "/usr/local/Cellar/boost/1.73.0/lib/cmake")
  get_filename_component(_BOOST_CMAKEDIR_ORIGINAL "/usr/local/Cellar/boost/1.73.0/lib/cmake" REALPATH)
  if(_BOOST_CMAKEDIR STREQUAL _BOOST_CMAKEDIR_ORIGINAL)
    set(_BOOST_CMAKEDIR "/usr/local/Cellar/boost/1.73.0/lib/cmake")
  endif()
...
foreach(dep_boost_stacktrace_windbg_cached IN LISTS _BOOST_STACKTRACE_WINDBG_CACHED_DEPS)
  ...
  find_package(boost_${dep_boost_stacktrace_windbg_cached} 1.73.0 EXACT CONFIG ${_BOOST_REQUIRED} ${_BOOST_QUIET} HINTS ${_BOOST_CMAKEDIR})
